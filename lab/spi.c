...
outportb(PORT1 + 0 , 0x80); /* Set Baud rate - Divisor Latch Low Byte */
...
/* 0x18 = 4,800 BPS */
/* 0x30 = 2,400 BPS */
outportb(PORT1 + 1 , 0x01); /* Set Baud rate - Divisor Latch High Byte */
...
outportb(PORT1, ch);
printf("%c",ch);} /* Send Char to Serial Port */
